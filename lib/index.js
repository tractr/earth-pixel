 ...
 * @typedef {Object} LocationWithKey
 * @property {number} latitude
 * @property {number} longitude
 * @property {string} key
 */
 ...
 * @typedef {Object} LocationWithWidth
 * @property {number} latitude
 * @property {number} longitude
...
class EarthPixel {
	 ...
	 * @method EarthPixel.prototype.key
	 */
	key(location) {
	 ...
	 * @returns {Location}
	 * @throws {Error} If the location object is malformed or has invalid coordinates
	 * @method EarthPixel.prototype.center
	 */
	center(location) {
	 ...
	 *
	 * @param {string} key
	 * @returns {LocationWithWidth}
	 * @throws {Error} If the key is malformed
	 * @method EarthPixel.extract
	 */
	static extract(key) {
		// Test key
		const regex = /^([0-9a-f]+)-([0-9a-f]+)-([0-9a-f]+)$/gim;
	 ...
	 * @returns {LocationWithKey}
	 * @throws {Error} If the location object is malformed or has invalid coordinates
	 * @method EarthPixel.prototype._subroutine
	 * @private
	 */
